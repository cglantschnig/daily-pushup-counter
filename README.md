...
Daily Pushup Counter is a small mobile-first workout app for running quick pushup sets in the browser. It generates a challenge, gives you an audio countdown, stores completed sets in Convex, and can schedule reminder notifications for the next check-in.
...
- Stores completed challenges in Convex.
- Shows recent history from the shared Convex deployment.
...
- Challenge history is stored anonymously in Convex and shared across clients using the same deployment.
